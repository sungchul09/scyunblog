  ...
  const projectList = [
    {
      ...
      list: [
        ...
        },
        {
          ...
          list: [
            "Nuxt 3 HMR 최적화로 <strong>개발 환경 로드 시간 1분 → 3초</strong> 이내로 개선",
            "Nuxt lifecycle hook을 활용한 메모리 캐시 구현으로 <strong>API 중복 호출 60~80% 감소</strong>",
          ],
        },
        {
        ...
        },
        {
          ...
          list: [
            ...
            "<strong>신규 기능 개발 기간 2주 → 5일로 단축</strong>, QA 소요 시간 1일 미만",
      ...
      list: [
        {
          ...
          list: [
            ...
            "<strong>사용자 서비스 문의량 50% 이상 감소</strong>",
        ...
        },
        {
          ...
          list: [
            ...
            "<strong>에러율 5% 미만 유지</strong>를 통해 시스템 안정화",
          ...
          <div key={index} className={companyBlockStyle}>
            <div className={companyHeaderStyle}>
              <div className={companyInfoStyle}>
                ...
                <span className={teamNameStyle}>{project.teamName}</span>
              </div>
